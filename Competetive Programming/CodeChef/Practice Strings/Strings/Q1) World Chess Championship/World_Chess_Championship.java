...
//Test case
//        1
//        1: Since Carlsen won all the games, he will be crowned the champion and will get
//60
//        ⋅
//X
...
//Test case
//        3
//        3: Carlsen and Chef both end up with
//14
...
class World_Chess_Championship
{
    public static void main(String[] args) throws java.lang.Exception
    {
        ...
        {
            int X = sc.nextInt();
            String total_points = sc.next();

            int Carlsen_points = 0;
            int Chef_points = 0;

            for (int j = 0; j <= total_points.length() - 1; j++)
            {
                char ch = total_points.charAt(j);
                if (ch == 'C')
                {
                    Carlsen_points += 2;
                }
            ...
            System.out.println(Carlsen_prize);
            i++;
        }
